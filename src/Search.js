...
export default class Search extends React.Component {
  ...
  //   return data.filter((n) => n.geographic_area_neighborhood_tabulation_area_nta_name !== undefined).map((n) => {
  //     return {value: this.convertStringToNTACode(n.geographic_area_neighborhood_tabulation_area_nta_name), label: n.geographic_area_neighborhood_tabulation_area_nta_name}
  //   })
  // }
  ...
  handleChange = (selectedOption) => {
    ...
    this.props.updateNeighborhood(selectedOption)
