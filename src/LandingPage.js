    ...
    return(
      <div className='landingpage'>
        {localStorage.token ?
          ...
          (<p style={{backgroundColor: 'rgba(0, 0, 0, .1)', padding: '5px', borderRadius: '15px'}}><img src={ttlogo} alt='treetrends logo'/><br></br><Link to='/login'><img src={login} alt='login'/></Link><Link to='/signup'><img src={signup} alt='signup'/></Link></p>)}
